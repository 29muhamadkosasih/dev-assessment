...
use App\Http\Controllers\AK01secondController;
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('fr_ak_03/cetak_pdf/{id}', [AK03Controller::class, 'pdf']);
    Route::get('fr_ak_05/cetak_pdf/{id}', [AK05Controller::class, 'pdf']);
    ...
    Route::get('fr_ak_05/get', [AK05Controller::class, 'get'])->name('get.fr_ak_05');
    Route::get('fr_ak_03/get', [AK03Controller::class, 'get'])->name('get.fr_ak_03');
    ...
    Route::put('fr_ak_01/update_data/{id}', [AK01Controller::class, 'update_data'])->name('fr_ak_01.update_data');
    Route::get('fr_ak_01/detail/{id}', [AK01Controller::class, 'detail'])->name('fr_ak_01.detail');
    Route::put('fr_ak_02/update_data/{id}', [AK02Controller::class, 'update_data'])->name('fr_ak_02.update_data');
    Route::get('fr_ak_02/detail/{id}', [AK02Controller::class, 'detail'])->name('fr_ak_02.detail');
    Route::put('fr_ak_04/update_data/{id}', [AK04Controller::class, 'update_data'])->name('fr_ak_04.update_data');
    Route::get('fr_ak_04/detail/{id}', [AK04Controller::class, 'detail'])->name('fr_ak_04.detail');
    Route::put('fr_ak_06/update_data/{id}', [AK06Controller::class, 'update_data'])->name('fr_ak_06.update_data');
    Route::get('fr_ak_06/detail/{id}', [AK06Controller::class, 'detail'])->name('fr_ak_06.detail');
    Route::put('fr_ak_05/update_data/{id}', [AK05Controller::class, 'update_data'])->name('fr_ak_05.update_data');
    Route::get('fr_ak_05/detail/{id}', [AK05Controller::class, 'detail'])->name('fr_ak_05.detail');
    Route::put('fr_ak_03/update_data/{id}', [AK03Controller::class, 'update_data'])->name('fr_ak_03.update_data');
    Route::get('fr_ak_03/detail/{id}', [AK03Controller::class, 'detail'])->name('fr_ak_03.detail');
    Route::get('apl_01/download/{file}', [APL01Controller::class, 'download'])->name('apl_01.download');
    Route::post('multipleusersdelete', [AK01Controller::class, 'multipleusersdelete']);
    Route::get('fr_ak_05/create_data', [AK05Controller::class, 'create_data'])->name('fr_ak_05.create_data');
