    ...
    <div id=halaman>
            ...
            <tbody class="table-border-bottom-0">
                <tr>
                    ...
                    <th>
                        ...
                        <img src="{{ asset('assets/img/favicon/ceklis.png') }}" width="28">
                        @break
                        @default
                        {{-- non ceklis --}}
                        <img src="{{ asset('assets/img/favicon/non_ceklis.png') }}" width="18">
                        @endswitch
                        Sertifikasi
                    </th>
                    <th>
        ...
        <table class="table" border=”1″ id="ping">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    @unless(!$datas->kompetensi->kode8)
                    <!-- Tampilkan data -->
                    <td width='40px' style="text-align: center">8</td>
                    <td width='150px'
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        {{$datas->kompetensi->kode8}}</td>
                    <td width='300px'
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        {{$datas->kompetensi->unit_kompetensi8}}</td>
                    @endunless
                </tr>

                <tr>
                    @unless(!$datas->kompetensi->kode9)
                    <!-- Tampilkan data -->
                    <td width='40px' style="text-align: center">9</td>
                    <td width='150px'
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        {{$datas->kompetensi->kode9}}</td>
                    <td width='300px'
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        {{$datas->kompetensi->unit_kompetensi9}}</td>
                    @endunless
                </tr>

                <tr>
                    @unless(!$datas->kompetensi->kode10)
                    <!-- Tampilkan data -->
                    <td width='40px' style="text-align: center">10</td>
                    <td width='150px'
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        {{$datas->kompetensi->kode10}}</td>
                    <td width='300px'
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        {{$datas->kompetensi->unit_kompetensi10}}</td>
                    @endunless
                </tr>

                <tr>
                    @unless(!$datas->kompetensi->kode11)
                    <!-- Tampilkan data -->
                    <td width='40px' style="text-align: center">11</td>
                    <td width='150px'
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        {{$datas->kompetensi->kode11}}</td>
                    <td width='300px'
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        {{$datas->kompetensi->unit_kompetensi11}}</td>
                    @endunless
                </tr>
        ...
        <table class="table" border=”1″ id="ping">
            <thead>
                <tr>
                    ...
                    <th width="165px" colspan="2">Memenuhi Pesyaratan </th>
            ...
            <thead>
                <tr>
                    <td rowspan="3"
                        ...
                        <b>Diterima</b>/ <b> <del>Tidak Diterima</del></b> *) sebagai peserta assessment
                    </td>
                    <td colspan="2"
                        style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                        <b>Pemohon
                ...
                <tr>
                    <td style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">Tanda
                        Tangan / Tanggal</td>
                    <td height="165px" style="text-align: center">
                        {{-- <img src="{{ asset('/storage/app/public/ttd/'. $datas->ttd) }}" style="width: 150px"> --}}
                        <br> {{ $datas->created_at }}
                    </td>
                </tr>
            </thead>
