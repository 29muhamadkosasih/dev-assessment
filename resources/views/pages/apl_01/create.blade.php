        ...
        <form action="{{ route('apl_01.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="form-tabs-social" role="tabpanel">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <label class="form-label d-block" for="plBathrooms">KTP &nbsp; <span
                                    style="font-size: 12px; color: red;">*) max. 10048 KB
                                    JPEG/PDF</span> </label>
                        ...
                        <div class="col-sm-6">
                            <label class="form-label" for="plFloorNo">Surat Keterangan Perusahaan &nbsp; <span
                                    style="font-size: 12px; color: red;">*) max. 10048 KB
                                    JPEG/PDF</span></label>
                        ...
                        <div class="col-sm-6">
                            <label class="form-label d-block" for="plBathrooms">Sertikat Pendukung &nbsp; <span
                                    style="font-size: 12px; color: red;">*) max. 10048 KB
                                    JPEG/PDF</span></label>
                        ...
                        <div class="col-sm-6">
                            <label class="form-label d-block" for="plBathrooms">CV &nbsp; <span
                                    style="font-size: 12px; color: red;">*) max. 10048 KB
                                    JPEG/PDF</span></label>
                        ...
                        <div class="col-sm-6">
                            <label class="form-label d-block" for="plBathrooms">Sertikat Pelatihan CBT &nbsp; <span
                                    style="font-size: 12px; color: red;">*) max. 10048 KB
                                    JPEG/PDF</span></label>
        ...
        <form action="{{ route('apl_01.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <label class="form-label d-block" for="plBathrooms">CV &nbsp; <span
                                style="font-size: 12px; color: red;">*) max.
                                10048 KB
                                JPEG/PDF</span></label>
                        <input type="file" id="plBathrooms" name="cv"
                            class="form-control @error('cv') is-invalid @enderror" placeholder="4" required />
