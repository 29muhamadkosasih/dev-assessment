...
@section('content')
<form action="{{ route('fr_ak_01.update_data', $edit->id) }}" method="POST" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <div class="col-12">
        <div class="card">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="10px">:</td>
                                <td><b>{{ $edit->rahasia->apl02->kompetensi02->kompetensi->skema->nama_skema }}</b></td>
                            </tr>
                            <tr>
                                <td>Nomor</td>
                                <td>:</td>
                                <td><b>{{ $edit->rahasia->apl02->kompetensi02->kompetensi->skema->no }}</b></td>
                            </tr>
                            <tr>
                                <td colspan="2">TUK</td>
                                <td>:</td>
                                <td>{{ $edit->rahasia->tuk }}</td>
                            </tr>
                            <tr>
                                <td colspan="2">Nama Asesor</td>
                                <td>:</td>
                                <td>{{ $edit->rahasia->nama_asesor_lsp }}</td>
                            </tr>
                            <tr>
                                <td colspan="2">Nama Asesi</td>
                                <td>:</td>
                                <td>{{$edit->rahasia->apl02->personal_detail->nama_lengkap->name}}</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    @switch($edit)
                                    @case($edit->b_bukti_1 == '1')
                                    <input name="b_bukti_1" class="form-check-input" type="radio" value="1"
                                    ...
                                    <input name="b_bukti_1" class="form-check-input" type="radio" value="2"
                                        id="defaultRadio1">
                                    <label class="form-check-label" for="defaultRadio1"> Observasi</label>
                                    @break
                            ...
                            <tr>
                                <td colspan="4">Pelaksanaan Asesmen disepakati pada :<br>Hari /Tanggal : <input
                                        type="date" class="form-control" name="p_date" value="{{ $edit->p_date }}">

                                    <br>Tempat Uji Kompetensi : <input type="text" name="p_tempat"
                                        value="{{ $edit->p_tempat }}" class="form-control">
