        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ \Carbon\Carbon::parse($show->tgl_mulai)->translatedFormat('l, j F Y') }}
                            </td>
                        </tr>
                        <tr>
                            <td>Tanggal Selesai Asemen</td>
                            <td>
                                {{ \Carbon\Carbon::parse($show->tgl_selesai)->translatedFormat('l, j F Y') }}
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom1_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom1_1" class="form-check-input" type="checkbox" value="1" checked>
                            ...
                            @switch($show)
                            @case($show->unit_kom1_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom1_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom1_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom1_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom1_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom1_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom1_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom1_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom1_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom1_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom1_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom1_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom2_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom2_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom2_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom2_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom2_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom2_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom2_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom2_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom2_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom2_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom2_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom2_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom2_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom2_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom3_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom3_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom3_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom3_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom3_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom3_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom3_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom3_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom3_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom3_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom3_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom3_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom3_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom3_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom4_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom4_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom4_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom4_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom4_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom4_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom4_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom4_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom4_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom4_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom4_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom4_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom4_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom4_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom5_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom5_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom5_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom5_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom5_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom5_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom5_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom5_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom5_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom5_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom5_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom5_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom5_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom5_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom6_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom6_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom6_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom6_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom6_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom6_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom6_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom6_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom6_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom6_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom6_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom6_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom6_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom6_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom7_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom7_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom7_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom7_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom7_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom7_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom7_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom7_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom7_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom7_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom7_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom7_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom7_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom7_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom8_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom8_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom8_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom8_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom8_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom8_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom8_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom8_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom8_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom8_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom8_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom8_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom8_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom8_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom9_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom9_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom9_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom9_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom9_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom9_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom9_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom9_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom9_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom9_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom9_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom9_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom9_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom9_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom10_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom10_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom10_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom10_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom10_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom10_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom10_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom10_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom10_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom10_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom10_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom10_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom10_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom10_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                        ...
                        <tr>
                            ...
                            @switch($show)
                            @case($show->unit_kom11_1 == 1 )

                            <td style="text-align: center">
                                <input name="unit_kom11_1" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom11_2 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom11_2" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom11_3 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom11_3" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom11_4 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom11_4" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom11_5 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom11_5" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom11_6 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom11_6" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                            ...
                            @switch($show)
                            @case($show->unit_kom11_7 == 1 )
                            <td style="text-align: center">
                                <input name="unit_kom11_7" class="form-check-input" type="checkbox" value="1" checked>
                                <label class="form-check-label"></label>
                            </td>
                            @break
                            @default
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                                @switch($show)
                                @case($show->tindak_lanjut == 'Kompeten')
                                <input name="tindak_lanjut" class="form-check-input mb-2" type="radio" value="Kompeten"
                                    checked>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">
                                ...
                                <input name="comment" class="form-check-input mb-3" type="radio" value="Belum Kompeten">
                ...
                <div class="col-12 d-flex justify-content-end mt-3">
                    <a href="{{ route('fr_ak_02.index') }}" class="btn btn-primary btn-submit" type="submit">Back</a>
                </div>
