$(document).ready(function () {
    ...
    $("#addRow").on("click", function () {
        t.row.add([counter + ".1", counter + ".2", counter + ".3", counter + ".4", counter + ".5"]).draw(!1), counter++
    }), $("#addRow").trigger("click"), $(".text-inputs-searching tfoot th").each(function () {
        var title = $(this).text();
    ...
    tableSearching.columns().every(function () {
        ...
        initComplete: function () {
            this.api().columns().every(function () {
                var column = this,
                    select = $('<select><option value="">Select option</option></select>').appendTo($(column.footer()).empty()).on("change", function () {
