...
<body>
    ...
    <main>
        <div id=halaman>
            ...
            <p id=judul>Pada bagian ini, termasuk data pribadi, data pendidikan formal serta data pekerjaan anda saat
                ini.
            </p>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="text-align: right"> &nbsp; &nbsp; &nbsp; &nbsp;:</td>
                    <td>{{ $datas->tempat_lahir}}, {{\Carbon\Carbon::parse($datas->tanggal_lahir)->format('d M Y')}}
                    </td>
                </tr>
                <tr>
            ...
            <table class="table" border=”1″ id="ping">
                <thead>
                    <tr>
                        ...
                        <th width="450px" rowspan="2">Bukti Persyaratan </th>
                        <th width="190px" colspan="2">Memenuhi Pesyaratan </th>
                        <th width="300px" rowspan="2">Catatan</th>
                    </tr>
                    <tr>
                        <th>Ya</th>
                        <th>Tidak</th>
            ...
            <table class="table" border=”1″ id="ping">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">KTP
                        </td>
                        <td style="text-align: center">
                            @switch($datas)
                            @case($datas->ktp == 0)
            ...
            <table class="table" border=”1″ id="ping">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">No.
                            Reg
                        </td>
                        <td style="text-align: left: vertical-align: top;padding-left: 10px; padding-right: 10px;">{{
                            $datas->no_reg }}
