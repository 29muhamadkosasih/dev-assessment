...
@section('content')
<form action="{{ route('fr_ak_03.update', $show->id) }}" method="POST" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <div class="col-12">
        <div class="card">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th width="10px">:</th>
                                <th colspan="2"><b>{{
                                        $show->feedback->apl02->kompetensi02->kompetensi->skema->nama_skema
                                        }}</b>
                                </th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td> <input type="date" name="tanggal" class="form-control" id=""></td>
                                <td>Waktu <input type="time" name="waktu" class="form-control"> </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered table-hover mt-3">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> <textarea name="note" class="form-control" id="" cols="0" rows="2"></textarea></td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note2" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note3" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note4" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note5" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note6" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note7" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note8" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note9" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <textarea name="note10" class="form-control" id="" cols="0" rows="2"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
